    ...
    <div class="resetHeight">
      ...
      <el-row type="flex" justify="center">
        <el-col :xs="12" :sm="5" :md="5" :lg="4" :xl="3" class="button">
          ...
          <a href="itms-services://?action=download-manifest&url=https://plist.gunchung.com/com.aboCompany.ABOIOS_1542075354.plist" v-if="versionType===2"><el-button type="primary" round>点击安装</el-button></a>
